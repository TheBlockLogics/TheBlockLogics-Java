...
public class BlockArg extends BlockBase {
  ...
  private RadioButton createImageRadioButton(String str) {
    ...
    LinearLayout.LayoutParams layoutParams =
        new LinearLayout.LayoutParams(-2, (int) (60.0f * LayoutUtil.getDip(getContext(), 1.0f)));
  ...
  private RadioButton createPairItem(String str, String str2) {
    ...
    LinearLayout.LayoutParams layoutParams =
        new LinearLayout.LayoutParams(-1, (int) (40.0f * LayoutUtil.getDip(getContext(), 1.0f)));
    radioButton.setGravity(19);
    radioButton.setLayoutParams(layoutParams);
    return radioButton;
  }
  ...
  private RadioButton createRadioButton(String str) {
    ...
    radioButton.setTag(str);
    LinearLayout.LayoutParams layoutParams =
        new LinearLayout.LayoutParams(-2, (int) (40.0f * LayoutUtil.getDip(getContext(), 1.0f)));
    radioButton.setGravity(19);
    radioButton.setLayoutParams(layoutParams);
    return radioButton;
  }
  ...
  private LinearLayout createRadioImage(String str, boolean z) {
    ...
    imageView.setLayoutParams(
        new LinearLayout.LayoutParams((int) (48.0f * dip), (int) (dip * 48.0f)));
    if (z) {
      ...
      // DrawableTypeRequest load = Glide.with(getContext()).load(Build.VERSION.SDK_INT >= 24 ?
      // FileProvider.getUriForFile(this.mContext,
      // this.mContext.getApplicationContext().getPackageName() + ".provider", new
      // File(DesignActivity.resourceManager.getImagePathFromName(str))) : Uri.fromFile(new
      // File(DesignActivity.resourceManager.getImagePathFromName(str))));
  ...
  private int getLabelWidth() {
    ...
    this.mTextView
        .getPaint()
        .getTextBounds(
            this.mTextView.getText().toString(), 0, this.mTextView.getText().length(), rect);
    ...
    */
    throw new UnsupportedOperationException(
        "Method not decompiled:"
            + " dev.trindadedev.theblocklogicsjava.ui.editor.block.BlockArg.init(android.content.Context):void");
  }
  ...
  private TextView makeEditText(String str) {
    ...
    RelativeLayout.LayoutParams layoutParams =
        new RelativeLayout.LayoutParams(this.defaultArgWidth, this.labelAndArgHeight);
  ...
  private void showColorPopup() {
    ...
    ColorPickerPopup colorPickerPopup =
        new ColorPickerPopup(
            ...
            (Activity) getContext(),
            (this.argValue == null
                    || this.argValue.toString().length() <= 0
                    || this.argValue.toString().indexOf("0xFF") != 0)
                ? 0
                : Color.parseColor(this.argValue.toString().replace("0xFF", "#")),
            true,
            false);
    colorPickerPopup.setColorSelectedListener(
        new ColorPickerPopup.ColorSelectedListener(this) {
          ...
          public void onColorSelected(int i) {
            if (i == 0) {
              ...
              this.this$0.setArgValue(
                  String.format("0xFF%06X", new Object[] {Integer.valueOf(16777215 & i)}));
            }
  ...
  private void showImagePopup() {
    ...
    while (it.hasNext()) {
      ...
      LinearLayout createRadioImage =
          ScDefine.isCustomEditMode(DesignActivity.getScId())
              ? str.equals("default_image")
                  ? createRadioImage(str, true)
                  : createRadioImage(str, false)
              : createRadioImage(str, true);
      createRadioImage.setOnClickListener(
          new View.OnClickListener(this, radioGroup) {
            final BlockArg this$0;
            ...
            public void onClick(View view) {
              ((RadioButton) this.val$rg.getChildAt(this.this$0.content.indexOfChild(view)))
                  .setChecked(true);
            }
          });
    ...
    builder.setPositiveButton(
        2131230886,
        new DialogInterface.OnClickListener(this, radioGroup) {
          final BlockArg this$0;
          final RadioGroup val$rg;
  ...
  public void showEditPopup(boolean z) {
    ...
    builder.setPositiveButton(
        2131230886,
        new DialogInterface.OnClickListener(this, editText, z) {
          final BlockArg this$0;
  ...
  public void showSelectPairPopup() {
    ...
    if (this.mMenuName.equals("view")) {
      ...
      arrayList =
          DesignActivity.designDataManager.getAllViewName(
              ProjectFileManager.getXmlNameFromJava(LogicEditorActivity.filename));
    } else if (this.mMenuName.equals("textview")) {
      builder.setTitle(getResources().getString(2131231555));
      arrayList =
          DesignActivity.designDataManager.getTextViewName(
              ProjectFileManager.getXmlNameFromJava(LogicEditorActivity.filename));
    } else if (this.mMenuName.equals("imageview")) {
      builder.setTitle(getResources().getString(2131231555));
      arrayList =
          DesignActivity.designDataManager.getViewNameByType(
              ProjectFileManager.getXmlNameFromJava(LogicEditorActivity.filename), 6);
    } else if (this.mMenuName.equals("checkbox")) {
      builder.setTitle(getResources().getString(2131231555));
      arrayList =
          DesignActivity.designDataManager.getViewNameByType(
              ProjectFileManager.getXmlNameFromJava(LogicEditorActivity.filename), 11);
    } else if (this.mMenuName.equals("listview")) {
      builder.setTitle(getResources().getString(2131231555));
      arrayList =
          DesignActivity.designDataManager.getViewNameByType(
              ProjectFileManager.getXmlNameFromJava(LogicEditorActivity.filename), 9);
    } else if (this.mMenuName.equals("spinner")) {
      builder.setTitle(getResources().getString(2131231555));
      arrayList =
          DesignActivity.designDataManager.getViewNameByType(
              ProjectFileManager.getXmlNameFromJava(LogicEditorActivity.filename), 10);
    } else if (this.mMenuName.equals("listSpn")) {
      builder.setTitle("select list (ListView, Spinner)");
      arrayList =
          DesignActivity.designDataManager.getListSpnName(
              ProjectFileManager.getXmlNameFromJava(LogicEditorActivity.filename));
    }
    ...
    while (it.hasNext()) {
      ...
      this.content.addView(
          createPairItem(
              DefineSource.getWidgetName(((Integer) pair.first).intValue()), (String) pair.second));
    }
  ...
  public void showSelectPopup() {
    ...
    if (this.mMenuName.equals("varInt")) {
      ...
      arrayList =
          DesignActivity.designDataManager.getVariablesByType(LogicEditorActivity.filename, 1);
    } else if (this.mMenuName.equals("varBool")) {
      builder.setTitle(getResources().getString(2131231531));
      arrayList =
          DesignActivity.designDataManager.getVariablesByType(LogicEditorActivity.filename, 0);
    } else if (this.mMenuName.equals("varStr")) {
      builder.setTitle(getResources().getString(2131231551));
      arrayList =
          DesignActivity.designDataManager.getVariablesByType(LogicEditorActivity.filename, 2);
      ...
      arrayList =
          DesignActivity.designDataManager.getComponentsByType(LogicEditorActivity.filename, 1);
    } else if (this.mMenuName.equals("file")) {
      builder.setTitle(getResources().getString(2131231536));
      arrayList =
          DesignActivity.designDataManager.getComponentsByType(LogicEditorActivity.filename, 2);
      ...
      if (this.mMenuName.equals("activity")) {
        ...
        arrayList =
            DesignActivity.designDataManager.getComponentsByType(LogicEditorActivity.filename, 3);
        ...
        arrayList =
            DesignActivity.designDataManager.getComponentsByType(LogicEditorActivity.filename, 4);
      } else if (this.mMenuName.equals("timer")) {
        builder.setTitle(getResources().getString(2131231553));
        arrayList =
            DesignActivity.designDataManager.getComponentsByType(LogicEditorActivity.filename, 5);
      } else if (this.mMenuName.equals("firebase")) {
        builder.setTitle(getResources().getString(2131231537));
        arrayList =
            DesignActivity.designDataManager.getComponentsByType(LogicEditorActivity.filename, 6);
      } else if (this.mMenuName.equals("dialog")) {
        builder.setTitle(getResources().getString(2131231535));
        arrayList =
            DesignActivity.designDataManager.getComponentsByType(LogicEditorActivity.filename, 7);
      } else if (this.mMenuName.equals("mediaplayer")) {
        builder.setTitle(getResources().getString(2131231547));
        arrayList =
            DesignActivity.designDataManager.getComponentsByType(LogicEditorActivity.filename, 8);
